class Gingo < Formula
    ...
    if OS.mac?
      url "https://github.com/hfadili-berkeley-systems/homebrew-gingo/releases/download/v1.0.5/gingo-mac-amd64"
      sha256 "c2cdd4f118508a1a7cfe009a985aa86399964cc736cd176d18120f1a88e24198"
    elsif OS.linux?
      url "https://github.com/hfadili-berkeley-systems/homebrew-gingo/releases/download/v1.0.5/gingo-linux"
